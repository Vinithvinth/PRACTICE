...
public class AllTheSubsetsOfAString {
	...
	public static void main(String[] args) {
	    ...
	    //The method creates a new string containing the characters from the specified 
	    //range (inclusive of beginIndex, exclusive of endIndex).
	                temp++;  
	            }  
	        }  
